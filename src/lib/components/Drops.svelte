...
<!-- if is footer and section is 1 -->
    ...
    <div class="lp:flex lp:flex-col lp:justify-start lp:my-auto"
        ...
        <div class="text-sm leading-none tracking-wide my-8 flex gap-3">
            <input type="radio" id="drop_0" value="0" bind:group={pickedDrop} on:change={handleDropChange} class="hidden peer/0"/>
