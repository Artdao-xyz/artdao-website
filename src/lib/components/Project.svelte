...
<div class="fixed h-fit w-fit left-0 bottom-0 lp:left-1/2 lp:top-1/2 lp:-translate-x-1/2 lp:-translate-y-1/2 bg-primary text-secondary flex flex-col lp:mx-auto lp:rounded-md tracking-wider z-20">
