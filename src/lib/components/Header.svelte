    ...
    <nav class="flex justify-between items-center w-mx-auto">
        ...
        <div bind:this={hamburguer_menu}
            ...
            <ul class="flex lp:flex-row flex-col  lp:items-center gap-8 ">
                <li><a on:click={() => setSection(0)} class="{section == 0 ? 'flex lp:flex-col gap-4 lp:gap-0 items-center justify-between' : 'opacity-30 flex lp:flex-col gap-4 lp:gap-0 items-center justify-between'}" href={"#"}><img loading="lazy" class=" lp:lp:mb-2" src={`/s1_${estilos[index].primary_media}.png`} alt="Section 1"><span class="{section == 0 ? '' : 'lp:invisible'}">Mission</span></a></li>        
            
                <li><a on:click={() => setSection(1)} class="{section == 1 ? 'flex lp:flex-col gap-4 lp:gap-0 items-center justify-between' : 'opacity-30 flex lp:flex-col  gap-4 lp:gap-0 items-center justify-between'}" href={"#"}><img loading="lazy" class=" lp:mb-2" src={`/s2_${estilos[index].primary_media}.png`} alt="Section 2"><span class="{section == 1 ? '' : 'lp:invisible'}">drops</span></a></li>
                <li><a on:click={() => setSection(2)} class="{section == 2 ? 'flex lp:flex-col gap-4 lp:gap-0 items-center justify-between' : 'opacity-30 flex lp:flex-col gap-4 lp:gap-0 items-center justify-between'}" href={"#"}><img loading="lazy" class=" lp:mb-2" src={`/s3_${estilos[index].primary_media}.png`} alt="Section 3"><span class="{section == 2 ? '' : 'lp:invisible'}">Events</span></a></li>
                <li><a on:click={() => setSection(3)} class="{section == 3 ? 'flex lp:flex-col gap-4 lp:gap-0 items-center justify-between' : 'opacity-30 flex lp:flex-col gap-4 lp:gap-0 items-center justify-between'}" href={"#"}><img loading="lazy" class=" lp:mb-2" src={`/s4_${estilos[index].primary_media}.png`} alt="Section 5"><span class="{section == 3 ? '' : 'lp:invisible'}">Studio</span></a></li>
                <div class="flex mt-24 items-center justify-between gap-2 lp:hidden">
                    <a href={'https://twitter.com/Artdao_xyz'} target="_blank"><img loading="lazy" src={`/x-${estilos[index].primary_media}.svg`} alt="X Logo"></a> 
                    ...
                    <a href={'#'}><img loading="lazy" src={`/discord-${estilos[index].primary_media}.svg`} alt="Discord Logo"></a>
