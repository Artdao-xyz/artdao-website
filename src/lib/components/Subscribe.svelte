...
<form method="POST" name="email" action={env.PUBLIC_API_ENDPOINT} class="bg-primary text-secondary flex items-center justify-between gap-4 p-4 rounded-lg mt-8 lp:mt-24">
