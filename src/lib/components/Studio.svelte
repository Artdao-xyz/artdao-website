    ...
    <div class="flex overflow-y-hidden w-[80%] text-primary flex-col gap-16 h-fit items-center justify-center mx-auto">
        ...
        <div class="hidden lp:block">
            ...
            <p class="text-center w-2/3 text-2xl font-semibold uppercase tracking-wide my-11 mx-auto">
                ...
                <br>
                <br>
                Balancing asset creation, style and composition to centre affective methods of communication and aesthetic resonances which cut across all aspects of your projects vision. 
            </p>
            <hr class="hidden lp:block border-primary">
        </div>
        <div class="flex flex-col lp:flex-row gap-16 w-full h-fit items-center lp:items-end justify-center lp:justify-start">
