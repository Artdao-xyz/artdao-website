...
>
	<div class="hidden lp:block">
		<h1 class="font-neue-power text-8xl font-medium capitalize tracking-wide text-center lp:mt-28">
			Artdao Studio
		</h1>
	...
	<div
		class="flex flex-col lp:flex-row gap-16 w-full h-fit items-center lp:items-end justify-center lp:justify-start lp:-mt-32"
	>
		<a
