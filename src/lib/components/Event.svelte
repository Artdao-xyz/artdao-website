...
<div
	class="fixed left-0 bottom-0 lp:left-1/2 lp:top-1/2 lp:-translate-x-1/2 lp:-translate-y-1/2 mx-auto bg-primary text-secondary flex flex-col lp:rounded-md tracking-wider"
>
	...
	<div class="w-screen lp:w-full h-full">
		<img
			loading="lazy"
			class="h-82 lp:h-full w-full lp:w-full object-cover"
